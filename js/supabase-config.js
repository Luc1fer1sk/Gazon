...
// HubSpot Forms (free CRM): заполните в формате строк.
// Пример:
// window.HUBSPOT_PORTAL_ID = '12345678';
// window.HUBSPOT_FORM_ID = 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx';
window.HUBSPOT_PORTAL_ID = '148768511';
